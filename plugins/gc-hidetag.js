//Código desarollado por Semi, https://wa.me/542932501120)
let handler = async(m, {conn, text, participants}) => {
  ...
  conn.sendMessage(m.chat, {text: text ? text : "@daiianaff", mentions: participants.map(u => conn.decodeJid(u.id))}, {quoted: m})
  }} else if (m.quoted) {
